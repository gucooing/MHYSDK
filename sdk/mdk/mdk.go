...
func GetCurrencyAndCountryByIp(c *gin.Context) {
...
func LoadConfig(c *gin.Context) {
	c.String(200, "{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":22,\"game_key\":\"hkrpg_global\",\"client\":\"IOS\",\"identity\":\"I_IDENTITY\",\"guest\":false,\"ignore_versions\":\"\",\"scene\":\"S_NORMAL\",\"name\":\"崩坏RPG\",\"disable_regist\":false,\"enable_email_captcha\":false,\"thirdparty\":[\"ap\",\"fb\",\"tw\",\"gc\"],\"disable_mmt\":false,\"server_guest\":false,\"thirdparty_ignore\":{},\"enable_ps_bind_account\":false,\"thirdparty_login_configs\":{\"fb\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"gc\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"tw\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":2592000},\"ap\":{\"token_type\":\"TK_GAME_TOKEN\",\"game_token_expires_in\":604800}},\"initialize_firebase\":true,\"bbs_auth_login\":false,\"bbs_auth_login_ignore\":[],\"fetch_instance_id\":true,\"enable_flash_login\":false,\"enable_logo_18\":false,\"logo_height\":\"0\",\"logo_width\":\"0\",\"enable_cx_bind_account\":false,\"firebase_blacklist_devices_switch\":false,\"firebase_blacklist_devices_version\":1,\"hoyolab_auth_login\":false,\"hoyolab_auth_login_ignore\":[],\"hoyoplay_auth_login\":false}}")
}

func GetAgreementInfos(c *gin.Context) {
	c.Header("Content-type", "application/json")
	_, _ = c.Writer.WriteString("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"marketing_agreements\":[]}}")
}

func ListPriceTier(c *gin.Context) {
	c.Header("Content-type", "application/json")
...
func VerifyRequestHandler(c *gin.Context) {
	...
	account = db.GetAccountByFieldAccountId(uint32(uid))
	if account.Username == "" {
...
func LoginRequestHandler(c *gin.Context) {
	...
	var account *constant.Account
	account = db.QueryAccountByFieldUsername(requestData.Account)
	if account.Username == "" {
		logger.Warn("在数据库中没有找到登录的账号")
		if IsAutoCreate {
			// 生成新的token
			token := base64.StdEncoding.EncodeToString(alg.GetRandomByte(24))
			...
			accountid, err = db.AddAccountFieldByFieldName(account)
			if err != nil {
